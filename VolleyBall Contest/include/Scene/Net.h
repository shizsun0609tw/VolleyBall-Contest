...
public:
	...
	void draw() {
		...
		_var::model.top() = glm::translate(_var::model.top(), -glm::vec3(0.f, 0.f, 4.5f));
		...
		_var::model.push(_var::model.top());
		_var::model.top() = glm::translate(_var::model.top(), glm::vec3(0.f, 0.f, 4.2f));
		_var::model.top() = glm::scale(_var::model.top(), glm::vec3(0.3f, 2.43f, 0.3f));
		_var::sendData();
		VAOManagement::drawVAO(BasicModel::cube);
		_var::model.pop();
		...
		_var::model.push(_var::model.top());
		_var::model.top() = glm::translate(_var::model.top(), glm::vec3(0.1f, 1.43f, -4.5f));
		_var::model.top() = glm::scale(_var::model.top(), glm::vec3(0.1f, 1.f, 9.f));
		_var::sendData();
		VAOManagement::drawVAO(BasicModel::cube);
		_var::model.pop();
	}
